...
async function seed() {
  ...
  const products = [
    ...
    { name: "Ubiquiti UniFi 6 Lite Access Point", sku: "NET-U6LITE", brand: "Ubiquiti", category: "networking", priceKes: 18500, stock: 28, trending: true, description: "Indoor Wi-Fi 6 access point with 1.5 Gbps aggregate throughput. Perfect for offices, hotels and multi-storey homes.", image: img("photo-1544197150-b99a5804f08d", 12) },
    { name: "MikroTik hEX S Gigabit Router", sku: "NET-HEXS", brand: "MikroTik", category: "networking", priceKes: 9800, stock: 35, description: "Five-port Gigabit wired router with SFP cage, dual-core 880 MHz CPU and RouterOS. A favourite for ISPs and CCTV backbones.", image: img("photo-1558494949-ef010cbdcc31", 13) },
    { name: "TP-Link TL-SG108 8-Port Gigabit Switch", sku: "NET-SG108", brand: "TP-Link", category: "networking", priceKes: 4500, stock: 80, description: "Unmanaged 8-port Gigabit switch. Plug-and-play expansion for desks, racks and camera cabinets.", image: img("photo-1551703599-2a3125d0c2c6", 14) },
    { name: "Cisco SG350-10P PoE Switch", sku: "NET-SG350", brand: "Cisco", category: "networking", priceKes: 42000, stock: 12, trending: true, description: "10-port managed Gigabit PoE switch with 62W budget. Powers access points, VoIP phones and IP cameras.", image: img("photo-1518770660439-4636190af475", 15) },
    ...
    { name: "Dahua IPC-HDW3849H 8MP Turret", sku: "CCTV-DH3849", brand: "Dahua", category: "cctv", priceKes: 14500, stock: 24, description: "8MP Full-color turret camera with warm LED, human/vehicle detection and built-in mic. Excellent night colour images.", image: img("photo-1585771724684-38269d6639fd", 22) },
    { name: "Hikvision DS-7608NI-K2 8-Channel NVR", sku: "CCTV-NVR8", brand: "Hikvision", category: "cctv", priceKes: 18500, stock: 18, trending: true, description: "8-channel 4K NVR with 80 Mbps incoming bandwidth, 2 SATA bays and HDMI/VGA output. Plug-and-play with Hikvision cameras.", image: img("photo-1557597774-9d273bd59043", 23) },
    { name: "Seagate SkyHawk 4TB Surveillance HDD", sku: "CCTV-SH4TB", brand: "Seagate", category: "cctv", priceKes: 12500, stock: 40, description: "Purpose-built 4TB drive for 24/7 NVR/DVR recording with ImagePerfect firmware.", image: img("photo-1531492746076-161ca2bcad58", 24) },
    { name: "Dahua 4MP PTZ Speed Dome", sku: "CCTV-PTZ4", brand: "Dahua", category: "cctv", priceKes: 28000, stock: 9, description: "4MP PTZ with 25x optical zoom, auto-tracking and IP66 housing for perimeter sites.", image: img("photo-1558002038-1055907df827", 25) },
    ...
    { name: "280kg Magnetic Lock Kit", sku: "AC-MAG280", brand: "ZKTeco", category: "access-control", priceKes: 4500, stock: 50, description: "Fail-safe maglock with Z-bracket, suitable for wooden and glass office doors.", image: img("photo-1558002038-1055907df827", 32) },
    { name: "RFID Proximity Cards — Pack of 50", sku: "AC-RFID50", brand: "ZKTeco", category: "access-control", priceKes: 2500, stock: 100, description: "125kHz EM cards compatible with most ZKTeco and generic RFID readers.", image: img("photo-1586953208448-b95d79e6060e", 33) },
    ...
    { name: "Cat6A SFTP Cable 305m Box", sku: "CAB-CAT6A-305", brand: "FS", category: "cabling", priceKes: 18500, stock: 20, description: "Shielded Cat6A for 10GbE backbones, PoE++ cameras and noisy industrial sites.", image: img("photo-1518770660439-4636190af475", 42) },
    { name: "LC-LC Single-mode Fiber Patch 3m", sku: "CAB-LCLC-3", brand: "FS", category: "cabling", priceKes: 650, stock: 200, description: "OS2 duplex LC-LC patch cord for SFP uplinks and FTTx cabinets.", image: img("photo-1544197150-b99a5804f08d", 43) },
    { name: "RJ45 Cat6 Connectors — 100 pcs", sku: "CAB-RJ45-100", brand: "FS", category: "cabling", priceKes: 900, stock: 150, description: "Gold-plated pass-through RJ45 plugs for Cat6 terminations.", image: img("photo-1551703599-2a3125d0c2c6", 44) },
    { name: "APC Back-UPS 650VA", sku: "PWR-APC650", brand: "APC", category: "power", priceKes: 12500, stock: 30, description: "Line-interactive UPS for routers, NVRs and small office PCs during Nairobi power dips.", image: img("photo-1473341304170-971dccb5ac1e", 51) },
    { name: "TP-Link Deco X20 Mesh 2-Pack", sku: "WIFI-DECOX20", brand: "TP-Link", category: "computers", priceKes: 16500, compareAtKes: 18900, stock: 16, trending: true, description: "Whole-home Wi-Fi 6 mesh covering up to 370 m². Seamless roaming for apartments and villas.", image: img("photo-1606904825846-647eb07f5be2", 61) },
  ];
  ...
  const orderSeed = [
    {
      ...
      user: brian.user,
      meta: brian.meta,
      items: linesFrom([["NET-AX55", 1], ["CCTV-HK2143", 1], ["NET-SG108", 1]]),
      status: "PROCESSING",
      paymentMethod: "MPESA",
    ...
    },
    {
      ...
      user: daniel.user,
      meta: daniel.meta,
      items: linesFrom([["NET-SG350", 1], ["CCTV-NVR8", 1]]),
    ...
    },
    {
      ...
      user: samuel.user,
      meta: samuel.meta,
      items: linesFrom([["NET-SG108", 2], ["CAB-CAT6-305", 1], ["AC-F18", 1]]),
      status: "DELIVERED",
    ...
    },
    {
      ...
      items: linesFrom([["CCTV-DH3849", 1], ["CCTV-SH4TB", 1]]),
      status: "PROCESSING",
      paymentMethod: "MPESA",
      paymentStatus: "COMPLETED",
      ref: "QKAMINA99",
    ...
    },
    {
      ...
      user: peter.user,
      meta: peter.meta,
      items: linesFrom([["NET-HEXS", 1], ["NET-SG108", 1]]),
      status: "DELIVERED",
      paymentMethod: "PESAPAL",
      paymentStatus: "COMPLETED",
      ref: "PSLPETER1",
    ...
    },
    {
      ...
      user: daniel.user,
      meta: daniel.meta,
      items: linesFrom([["CCTV-NVR8", 1], ["CCTV-SH4TB", 2]]),
      status: "SHIPPED",
      paymentMethod: "PESAPAL",
      paymentStatus: "COMPLETED",
      ref: "PSLDAN12",
